...
- **Answer**: As mentioned above, the simplicity of difference-in-differences makes it easily interpretable, but comes at a cost of only being able to compare two units. Synthetic control allows us to draw from multiple comparison units to create a control that may more closely align with the pre-treatment outcome trends of the treated unit, as we saw above in question 4 where it was difficult to find a good match for our selected treated state (California). Drawing from multiple comparison units also spreads the threat of post-treatment confounding across multiple units, rather than rely on there being none in our singular control unit with difference-in-differences. 
